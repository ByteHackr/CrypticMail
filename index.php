...
<link rel="apple-touch-icon" sizes="57x57" href="img/favicons/icon.png">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right main-nav">
					...
					<li><a href="index.php?chk=login">Login</a></li>
					<li><a href="index.php?chk=registraion">SignUp</a></li>
...
<table width="975" border="0" align="center" style="background-image:url('slide image/bkgrnd_greydots.png');">
  ...
  <tr>
	...
	<img src="images/about-carousel-1.png" class="img-responsive">
	<pre>
